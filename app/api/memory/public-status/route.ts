...
export async function GET() {
  return NextResponse.json({
    ...
    version: 'intelligence-amplification-v3',
    last_polish: {
      commit: 'local-roadmap-v3',
      focus: 'LLM intelligence amplification roadmap, compact redaction, benchmark v6 eval layer, lower-tier bootstrap simulation, and retrieval relevance baseline',
    ...
    evidence: {
      ...
      intelligence_eval: 'zenos-memory-intelligence-amplification-v3',
      ...
      dashboard_cards: ['Smoke Suite', 'Benchmark V6', 'Lower-tier Bootstrap Eval', 'SDK Imports'],
    },
